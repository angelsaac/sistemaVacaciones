...
else
{
    ...
    $deptcode = $deptcode;
    $conn -> query("INSERT INTO tbldepartments(DepartmentName,DepartmentCode,DepartmentShortName) VALUES('$deptname','$deptcode','$deptshortname')");
    if($conn)
    {
        // echo "<script>alert('Departamento actualizado exitósamente');</script>";
                        ...
                        <div class="row">
                            <form class="col s12" name="chngpwd" method="post">
                                <?php if($error){?><div class="errorWrap">
                                    <strong>ERROR</strong>:<?php echo $error; ?> </div><?php } 
                                else if($msg){?><div class="succWrap"><strong>Proceso
                                        Exitoso</strong>:<?php echo $msg; ?> </div><?php }?>
                                <div class="row">
                                    ...
                                    <div class="input-field col s12">
                                        ...
                                        <label for="password">Número de centro</label>
                                    </div>
