...
$sql="INSERT INTO tblemployees(EmpId,FirstName,LastName,EmailId,Password,Gender,Dob,Department,Experience,Days, TotalVacations, Occupation,Address,Phonenumber,Status) 
VALUES($empid,'$fname','$lname','$email','$password','$dob','$department','$experience', 0, 0,'$occupation','$address', $mobileno, $status)";
 if(mysqli_query($conn, $sql))
    ...
    SET tblemployees.TotalVacations=tblvacations.Vacations WHERE tblemployees.EmpId= $empid ";
    ...
    <main class="mn-inner">
        <div class="row">
            ...
            <div class="col s12 m12 l12">
                ...
                else if($msg){?><div class="succWrap"><strong>Proceso
                                                            Exitoso</strong>:<?php echo htmlentities($msg); ?> </div>
                                                    <?php }?>
                         ...
                         -->
                                                    ...
                                                    <div class="input-field col s12">
                                                        <button type="submit" name="add" onclick="return valid();"
                                                            id="add"
                                                            class="waves-effect waves-light btn indigo m-b-xs">Agregar</button>
