...
$unreadcount=$query->rowCount();?>
                            ...
                            <li class="hide-on-med-and-up"><a href="javascript:void(0)" class="search-toggle"><i
                                        class="material-icons">Buscar</i></a></li>
                        </ul>
...
from tblleaves join tblemployees on tblleaves.empid=tblemployees.empid
...
{               ?>
                                    ...
                                    <li>
                                    <a href="leave-details.php?numemp=<?php echo ($result->emp);?>&id=<?php echo ($result->id);?>">
                                            <div class="notification">
                                                <div class="notification-icon circle cyan"><i
                                                        class="material-icons">done</i></div>
                                                <div class="notification-text">
                                                    <p><b><?php echo ($result->FirstName." ".$result->LastName);?><br />(<?php echo ($result->EmpId);?>)</b>
                                                        fecha de la solicitud</p><span>
                                                        <?php echo ($result->PostingDate);?></b< /span>
                                                </div>
                                            </div>
                                        </a>
                                    </li>
