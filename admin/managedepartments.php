...
if(isset($_GET['del']))
{
    ...
    {
        $msg="Registro de Departamento Borrado Exitosamente";
    }
    else
    {
...
{               ?>
                                <tr>
                                    ...
                                    <td><a href="editdepartment.php?deptid=<?php echo $result->id;?>"><i
                                                class="material-icons">mode_edit</i></a><a
                                            href="managedepartments.php?del=<?php echo $result->id;?>"
                                            onclick="return confirm('Confirma si deseas efectivamente eliminar el departamento');">
